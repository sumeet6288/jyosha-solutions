...
- **URL**: https://app-db-preview.preview.emergentagent.com
- **Status**: ✅ Accessible

### Backend API
- **Base URL**: https://app-db-preview.preview.emergentagent.com/api
- **Documentation**: https://app-db-preview.preview.emergentagent.com/docs
- **Status**: ✅ Accessible
...
1. Open https://app-db-preview.preview.emergentagent.com
2. Click "Sign In"
3. Use credentials:
   - Email: `admin@botsmith.com`
   - Password: `admin123`
