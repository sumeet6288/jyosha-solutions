...
https://stack-preview-2.preview.emergentagent.com

**Backend API:**
- Internal: http://localhost:8001
- External: https://stack-preview-2.preview.emergentagent.com/api

**API Documentation:**
https://stack-preview-2.preview.emergentagent.com/api/docs
...
### Frontend (.env)
- `REACT_APP_BACKEND_URL`: https://stack-preview-2.preview.emergentagent.com
- `WDS_SOCKET_PORT`: 443
