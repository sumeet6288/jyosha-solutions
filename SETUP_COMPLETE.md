...
https://full-stack-setup-2.preview.emergentagent.com

**Backend API:**
- Internal: http://localhost:8001
- External: https://full-stack-setup-2.preview.emergentagent.com/api

**API Documentation:**
https://full-stack-setup-2.preview.emergentagent.com/api/docs
...
### Frontend (.env)
- `REACT_APP_BACKEND_URL`: https://full-stack-setup-2.preview.emergentagent.com
- `WDS_SOCKET_PORT`: 443
