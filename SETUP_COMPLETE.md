...
https://web-stack-preview-1.preview.emergentagent.com

**Backend API:**
- Internal: http://localhost:8001
- External: https://web-stack-preview-1.preview.emergentagent.com/api

**API Documentation:**
https://web-stack-preview-1.preview.emergentagent.com/api/docs
...
### Frontend (.env)
- `REACT_APP_BACKEND_URL`: https://web-stack-preview-1.preview.emergentagent.com
- `WDS_SOCKET_PORT`: 443
