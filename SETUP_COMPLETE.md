...
https://db-ready-deploy.preview.emergentagent.com

**Backend API:**
- Internal: http://localhost:8001
- External: https://db-ready-deploy.preview.emergentagent.com/api

**API Documentation:**
https://db-ready-deploy.preview.emergentagent.com/api/docs
...
### Frontend (.env)
- `REACT_APP_BACKEND_URL`: https://db-ready-deploy.preview.emergentagent.com
- `WDS_SOCKET_PORT`: 443
