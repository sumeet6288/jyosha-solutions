...
**Callback URL**: 
```
https://install-creds-demo.preview.emergentagent.com/api/lemonsqueezy/webhook
```
...
1. Navigate to: https://install-creds-demo.preview.emergentagent.com/subscription
