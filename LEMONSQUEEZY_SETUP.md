...
**Callback URL**: 
```
https://depend-installer-1.preview.emergentagent.com/api/lemonsqueezy/webhook
```
...
1. Navigate to: https://depend-installer-1.preview.emergentagent.com/subscription
