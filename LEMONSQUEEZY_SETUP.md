...
**Callback URL**: 
```
https://install-preview-2.preview.emergentagent.com/api/lemonsqueezy/webhook
```
...
1. Navigate to: https://install-preview-2.preview.emergentagent.com/subscription
