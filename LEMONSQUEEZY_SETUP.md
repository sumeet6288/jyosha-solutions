...
**Callback URL**: 
```
https://install-deps-preview.preview.emergentagent.com/api/lemonsqueezy/webhook
```
...
1. Navigate to: https://install-deps-preview.preview.emergentagent.com/subscription
