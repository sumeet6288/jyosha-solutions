...
**Callback URL**: 
```
https://setup-install-view.preview.emergentagent.com/api/lemonsqueezy/webhook
```
...
1. Navigate to: https://setup-install-view.preview.emergentagent.com/subscription
