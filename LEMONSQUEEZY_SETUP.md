...
**Callback URL**: 
```
https://fast-dependency-bot.preview.emergentagent.com/api/lemonsqueezy/webhook
```
...
1. Navigate to: https://fast-dependency-bot.preview.emergentagent.com/subscription
