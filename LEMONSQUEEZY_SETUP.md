...
**Callback URL**: 
```
https://dependency-preview.preview.emergentagent.com/api/lemonsqueezy/webhook
```
...
1. Navigate to: https://dependency-preview.preview.emergentagent.com/subscription
