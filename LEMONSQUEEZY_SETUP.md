...
**Callback URL**: 
```
https://quick-installer-3.preview.emergentagent.com/api/lemonsqueezy/webhook
```
...
1. Navigate to: https://quick-installer-3.preview.emergentagent.com/subscription
