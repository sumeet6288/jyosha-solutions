...
**Callback URL**: 
```
https://quick-preview-deps.preview.emergentagent.com/api/lemonsqueezy/webhook
```
...
1. Navigate to: https://quick-preview-deps.preview.emergentagent.com/subscription
