...
**Callback URL**: 
```
https://depend-setup-view.preview.emergentagent.com/api/lemonsqueezy/webhook
```
...
1. Navigate to: https://depend-setup-view.preview.emergentagent.com/subscription
