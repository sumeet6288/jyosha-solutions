...
- **Webhook URL Generation**: Working
  - URL: `https://depstream.preview.emergentagent.com/api/slack/webhook/{chatbot_id}`
...
4. **Configure Event Subscriptions**
   ...
   - Enable Events
   - Set Request URL: `https://depstream.preview.emergentagent.com/api/slack/webhook/{your-chatbot-id}`
