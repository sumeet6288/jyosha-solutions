...
- **Webhook URL Generation**: Working
  - URL: `https://setup-view.preview.emergentagent.com/api/slack/webhook/{chatbot_id}`
...
4. **Configure Event Subscriptions**
   ...
   - Enable Events
   - Set Request URL: `https://setup-view.preview.emergentagent.com/api/slack/webhook/{your-chatbot-id}`
