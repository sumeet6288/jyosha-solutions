...
- **Webhook URL Generation**: Working
  - URL: `https://quick-preview-50.preview.emergentagent.com/api/slack/webhook/{chatbot_id}`
...
4. **Configure Event Subscriptions**
   ...
   - Enable Events
   - Set Request URL: `https://quick-preview-50.preview.emergentagent.com/api/slack/webhook/{your-chatbot-id}`
