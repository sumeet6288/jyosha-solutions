...
- **Webhook URL Generation**: Working
  - URL: `https://install-and-show-2.preview.emergentagent.com/api/slack/webhook/{chatbot_id}`
...
4. **Configure Event Subscriptions**
   ...
   - Enable Events
   - Set Request URL: `https://install-and-show-2.preview.emergentagent.com/api/slack/webhook/{your-chatbot-id}`
