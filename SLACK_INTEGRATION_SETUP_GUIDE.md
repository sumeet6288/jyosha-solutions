...
2. Copy the webhook URL that appears
   - It will look like: `https://setup-display.preview.emergentagent.com/api/slack/webhook/[your-chatbot-id]`
...
2. Check that the URL is exactly: `https://setup-display.preview.emergentagent.com/api/slack/webhook/[chatbot-id]`
