...
1. Go to your BotSmith dashboard: **https://depfix-preview.preview.emergentagent.com**
...
2. Copy the webhook URL that appears
   - It will look like: `https://depfix-preview.preview.emergentagent.com/api/slack/webhook/[your-chatbot-id]`
...
2. Check that the URL is exactly: `https://depfix-preview.preview.emergentagent.com/api/slack/webhook/[chatbot-id]`
