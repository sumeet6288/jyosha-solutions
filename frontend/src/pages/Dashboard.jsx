        ...
        <div className="px-4 sm:px-6 py-4 flex items-center justify-between max-w-7xl mx-auto">
          <div className="flex items-center gap-2">
            <div className="flex items-center gap-2 cursor-pointer group" onClick={() => navigate('/dashboard')}>
              ...
              <span className="text-lg sm:text-xl font-semibold bg-gradient-to-r from-gray-900 to-purple-600 bg-clip-text text-transparent">Chatbase</span>
            </div>
          </div>
          ...
          <div className="md:hidden border-t border-gray-200 bg-white/95 backdrop-blur-lg">
            <div className="px-4 py-3 space-y-3">
              <button 
                ...
                className="w-full text-left px-4 py-3 text-purple-600 font-semibold bg-purple-50 rounded-lg"
              >
                Chatbots
              </button>
              <button 
              ...
              <button 
                onClick={() => { navigate('/integrations'); setMobileMenuOpen(false); }}
                className="w-full text-left px-4 py-3 text-gray-700 hover:bg-gray-100 rounded-lg transition-colors"
              >
                Integrations
              </button>
