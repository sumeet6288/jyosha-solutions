          ...
          <div className="relative group card-entrance">
            ...
            <div className="relative bg-white/80 backdrop-blur-2xl rounded-3xl shadow-2xl p-6 border border-white/60 transform transition-all duration-500 hover:shadow-purple-500/30">
              ...
              <div className="space-y-3 mb-8">
                <h1 className="text-5xl font-black font-heading bg-gradient-to-r from-purple-700 via-pink-600 to-orange-600 bg-clip-text text-transparent animate-slide-in-left leading-tight">
                  Welcome back
                </h1>
                <p className="text-gray-600 text-lg font-body animate-slide-in-left stagger-1">Sign in to continue your journey with AI</p>
              </div>
