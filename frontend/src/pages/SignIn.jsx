          ...
          <div className="relative group card-entrance">
            ...
            <div className="relative bg-white/80 backdrop-blur-2xl rounded-3xl shadow-2xl p-6 border border-white/60 transform transition-all duration-500 hover:shadow-purple-500/30">
              ...
              <form onSubmit={handleSubmit} className="space-y-4">
                ...
                <div className="flex items-center justify-between animate-fade-in-scale stagger-4 text-xs">
                  ...
                  <button type="button" className="text-purple-600 hover:text-pink-600 font-semibold transition-colors font-body hover:underline">
                    Forgot password?
                  </button>
                </div>
