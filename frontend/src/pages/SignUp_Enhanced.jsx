  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-purple-50 via-pink-50 to-orange-50 flex relative overflow-hidden">
      ...
      >
        ...
        <div className="absolute w-[700px] h-[700px] bg-gradient-to-br from-orange-400/30 to-pink-400/30 rounded-full blur-3xl animate-blob animate-morph top-0 -right-40"></div>
        <div className="absolute w-[600px] h-[600px] bg-gradient-to-br from-purple-400/25 to-cyan-400/20 rounded-full blur-3xl animate-blob animation-delay-2000 animate-morph top-32 -left-32"></div>
        <div className="absolute w-[650px] h-[650px] bg-gradient-to-br from-pink-400/25 to-purple-400/30 rounded-full blur-3xl animate-blob animation-delay-4000 animate-morph -bottom-40 right-1/4"></div>
            ...
            <div className="relative bg-white/80 backdrop-blur-2xl rounded-3xl shadow-2xl p-8 border border-white/60 transform transition-all duration-500 hover:shadow-purple-500/30">
              ...
              <div className="flex items-center gap-3 mb-8 group/logo cursor-pointer animate-slide-in-top" onClick={() => navigate('/')}>
                <div className="relative">
                  ...
                  <div className="relative w-14 h-14 bg-gradient-to-br from-purple-600 via-fuchsia-500 to-pink-600 rounded-xl flex items-center justify-center transform group-hover/logo:scale-110 group-hover/logo:rotate-12 transition-all duration-500 shadow-xl border-2 border-white/40">
                    <div className="absolute inset-0 rounded-xl bg-gradient-to-br from-white/50 to-transparent opacity-70"></div>
                    
                    <Sparkles className="w-7 h-7 text-white relative z-10 drop-shadow-lg animate-heartbeat" />
                  </div>
                </div>
                
                <div className="flex flex-col -space-y-0.5">
                  <div className="flex items-baseline gap-1">
                    <span className="text-3xl font-black font-heading tracking-tight bg-gradient-to-r from-purple-700 via-fuchsia-600 to-pink-600 bg-clip-text text-transparent animate-rainbow">
                      BotSmith
                    </span>
                    <span className="text-[11px] font-bold text-purple-600 bg-purple-100 px-2 py-0.5 rounded-full animate-bounce-in stagger-1">AI</span>
                  </div>
                </div>
              </div>
              ...
              <div className="space-y-3 mb-8">
                <h1 className="text-5xl font-black font-heading bg-gradient-to-r from-purple-700 via-pink-600 to-orange-600 bg-clip-text text-transparent animate-slide-in-right leading-tight">
                  Create your account
                </h1>
                <p className="text-gray-600 text-lg font-body animate-slide-in-right stagger-1">Start building your AI agents today</p>
              </div>
              
              <form onSubmit={handleSubmit} className="space-y-6">
                {/* Name Input */}
                <div className="group/input animate-fade-in-scale stagger-2">
                  <Label htmlFor="name" className="text-gray-700 font-semibold mb-2 flex items-center gap-2 font-heading">
                    <User className="w-4 h-4 text-purple-600" />
                    Full Name
                  </Label>
                  <div className={`relative mt-2 transition-all duration-500 ${focusedField === 'name' ? 'scale-[1.03] shadow-2xl shadow-purple-500/30' : ''}`}>
                    <Input
                      id="name"
                      type="text"
                    ...
                    <div className="mt-4 space-y-3 animate-fade-in">
                      ...
                      <div className="flex items-center justify-between text-sm">
                        ...
                        <div className="flex gap-3">
                          <span className={`flex items-center gap-1 font-body ${passwordStrength.checks.length ? 'text-green-600' : 'text-gray-400'}`}>
                            {passwordStrength.checks.length ? <Check className="w-4 h-4" /> : <X className="w-4 h-4" />}
                            8+ chars
                          </span>
                          <span className={`flex items-center gap-1 font-body ${passwordStrength.checks.number ? 'text-green-600' : 'text-gray-400'}`}>
