            ...
            <div className="relative bg-white/80 backdrop-blur-2xl rounded-3xl shadow-2xl p-6 border border-white/60 transform transition-all duration-500 hover:shadow-purple-500/30">
              ...
              <form onSubmit={handleSubmit} className="space-y-4">
                ...
                <div className="group/input animate-fade-in-scale stagger-3">
                  ...
                  <div className={`relative mt-1.5 transition-all duration-500 ${focusedField === 'email' ? 'scale-[1.03] shadow-2xl shadow-purple-500/30' : ''}`}>
                    <Input
                      id="email"
                      type="email"
                ...
                <div className="group/input animate-fade-in-scale stagger-4">
                  ...
                  <div className={`relative mt-1.5 transition-all duration-500 ${focusedField === 'password' ? 'scale-[1.03] shadow-2xl shadow-purple-500/30' : ''}`}>
                    <Input
                      id="password"
                      ...
                      onBlur={() => setFocusedField('')}
                      className="pl-3 pr-12 py-5 font-body text-sm bg-white/60 backdrop-blur-sm border-2 border-purple-200/60 focus:border-purple-500 focus:bg-white/90 rounded-xl transition-all duration-500 focus:shadow-2xl focus:shadow-purple-500/30"
                      required
                    />
                    <button
                      type="button"
