            ...
            <div className="relative bg-white rounded-2xl md:rounded-3xl shadow-2xl p-4 sm:p-6 border border-gray-200 transform transition-all duration-500 hover:shadow-purple-500/20">
              ...
              <form onSubmit={handleSubmit} className="space-y-3 sm:space-y-4">
                ...
                <div className="grid grid-cols-2 gap-2 sm:gap-3">
                  <button type="button" className="group/social flex items-center justify-center gap-1.5 sm:gap-2 px-2 sm:px-3 py-2.5 sm:py-3 bg-white border-2 border-gray-200 rounded-xl hover:border-purple-400 hover:bg-purple-50 hover:shadow-lg hover:shadow-purple-500/10 transition-all duration-500 transform hover:scale-105 animate-slide-in-bottom-entrance stagger-6">
                    ...
                    <span className="text-xs font-bold text-gray-700 font-body hidden xs:inline">Google</span>
                  </button>
                  <button type="button" className="group/social flex items-center justify-center gap-1.5 sm:gap-2 px-2 sm:px-3 py-2.5 sm:py-3 bg-white border-2 border-gray-200 rounded-xl hover:border-purple-400 hover:bg-purple-50 hover:shadow-lg hover:shadow-purple-500/10 transition-all duration-500 transform hover:scale-105 animate-slide-in-bottom-entrance animation-delay-300">
                    ...
                    <span className="text-xs font-bold text-gray-700 font-body hidden xs:inline">GitHub</span>
                  </button>
                </div>
              </form>
