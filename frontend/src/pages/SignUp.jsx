...
import { Mail, Lock, Eye, EyeOff, Sparkles, User, Check, X } from 'lucide-react';
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-purple-50 via-pink-50 to-orange-50 flex relative overflow-hidden">
      ...
      <div className="absolute inset-0 overflow-hidden pointer-events-none">
        ...
        <div className="absolute w-[550px] h-[550px] bg-gradient-to-br from-pink-400/25 to-orange-400/25 rounded-full blur-3xl animate-blob animation-delay-4000 -bottom-40 right-1/4"></div>
      ...
      {/* Left Side - Enhanced Animated Gradient with 3D Effects */}
      <div className="hidden md:block md:w-1/2 relative overflow-hidden">
        <div className="absolute inset-0 bg-gradient-to-br from-orange-500 via-pink-500 to-purple-500">
          {/* Animated overlay layers */}
          <div className="absolute inset-0 bg-gradient-to-tl from-purple-600/50 via-transparent to-orange-600/50 animate-pulse-slow"></div>
          <div className="absolute inset-0 bg-gradient-to-br from-pink-500/30 via-transparent to-purple-500/30 animate-pulse-slow animation-delay-2000"></div>
          
          {/* Floating shapes */}
          <div className="absolute top-40 right-20 w-32 h-32 bg-white/10 rounded-full blur-2xl animate-float"></div>
          ...
          <div className="absolute top-1/2 right-1/3 w-24 h-24 bg-white/10 rounded-full blur-2xl animate-float animation-delay-4000"></div>
          ...
          <div className="absolute inset-0 flex flex-col items-center justify-center p-12 text-white">
            <div className="max-w-md text-center space-y-6 transform hover:scale-105 transition-transform duration-500">
              <div className="inline-block p-4 bg-white/10 backdrop-blur-sm rounded-2xl mb-4 animate-pulse-slow">
              ...
              <div className="flex items-center justify-center gap-8 mt-8">
                <div className="text-center">
                  ...
                  <div className="text-sm opacity-80">To Start</div>
                </div>
      ...
      {/* Right Side - Enhanced Form with Glass Morphism */}
      <div className="w-full md:w-1/2 flex items-center justify-center p-4 sm:p-8 relative z-10">
        <div className="w-full max-w-md">
          {/* Premium Glass Card */}
          <div className="relative group">
            {/* Glow effect */}
            <div className="absolute -inset-1 bg-gradient-to-r from-orange-600 via-pink-600 to-purple-600 rounded-3xl opacity-20 group-hover:opacity-30 blur-xl transition-all duration-500"></div>
            ...
            <div className="relative bg-white/70 backdrop-blur-xl rounded-3xl shadow-2xl p-8 border border-white/50 transform transition-all duration-500 hover:shadow-purple-500/20">
              ...
              <div className="space-y-2 mb-8">
                ...
                <p className="text-gray-600 text-lg">Start building your AI agents today</p>
              </div>
              
              <form onSubmit={handleSubmit} className="space-y-5">
                {/* Name Input with Enhanced Design */}
                <div className="group/input">
                  <Label htmlFor="name" className="text-gray-700 font-semibold mb-2 flex items-center gap-2">
                    <User className="w-4 h-4 text-purple-600" />
                    Full Name
                  </Label>
                  <div className={`relative mt-2 transition-all duration-300 ${focusedField === 'name' ? 'scale-[1.02]' : ''}`}>
                    <Input
                      id="name"
                      type="text"
                        ...
                        <div className="flex gap-2">
                          {passwordStrength.checks.length && (
                            <span className="flex items-center gap-1 text-gray-600">
                              {passwordStrength.checks.length ? <Check className="w-3 h-3 text-green-500" /> : <X className="w-3 h-3 text-gray-400" />}
                              8+ chars
                            </span>
                          )}
                        </div>
              ...
              <p className="mt-8 text-center text-gray-600">
                ...
                <button onClick={() => navigate('/signin')} className="text-purple-600 font-bold hover:text-pink-600 transition-colors hover:underline">
                  Sign in
                </button>
              </p>
            </div>
